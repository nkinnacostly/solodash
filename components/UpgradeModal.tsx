...
export default function UpgradeModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-[#141419] border border-[#26262e] rounded-2xl max-w-md w-full p-6 shadow-xl">
        {/* Close button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-1 hover:bg-[#26262e] rounded-lg transition-colors"
        >
        ...
        {/* Feature Comparison */}
        <div className="bg-[#0a0a0b] border border-[#26262e] rounded-xl p-4 mb-6">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={onClose}
            className="w-full py-3 border border-[#26262e] text-[#a1a1aa] font-medium rounded-lg hover:border-[#3a4353] hover:text-white transition-colors"
          >
            Maybe later
          </button>
        </div>
