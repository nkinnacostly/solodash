...
export const metadata: Metadata = {
  ...
  description:
    "How Paidly collects, uses, and protects your data — invoices, contracts, client information, and payment details — for African freelancers using getpaidly.co.",
...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-[#0a0a0b] text-white antialiased">
      {/* NAVBAR */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0b]/90 backdrop-blur-md border-b border-[#26262e]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link
              href="/signup"
              className="px-4 py-2 text-sm bg-[#2563eb] text-[#ffffff] font-medium rounded-lg hover:bg-[#1d4ed8] transition-colors"
            >
              Start free
            </Link>
          </div>
      ...
      <main className="pt-32 pb-20 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-bold text-[#3b82f6] mb-4">
            Privacy Policy
          </h1>
      ...
      {/* FOOTER */}
      <footer className="border-t border-[#26262e] py-8 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <span className="text-lg font-bold text-[#3b82f6]">Paidly</span>
