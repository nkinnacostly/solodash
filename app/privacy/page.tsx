...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-[#14171d] text-white antialiased">
      {/* NAVBAR */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#14171d]/90 backdrop-blur-md border-b border-[#2a303c]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="text-xl font-bold text-[#6ea8ff]">
            Paidly
          </Link>
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link
              href="/signup"
              className="px-4 py-2 text-sm bg-[#6ea8ff] text-[#0e1116] font-medium rounded-lg hover:bg-[#5b93e6] transition-colors"
            >
              Start free
            </Link>
          </div>
      ...
      <main className="pt-32 pb-20 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-bold text-[#6ea8ff] mb-4">
            Privacy Policy
          </h1>
          <p className="text-[#8f9db1] mb-12">Last updated: April 2026</p>

          <div className="space-y-12">
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-[#6ea8ff]">
                1. Introduction
              </h2>
              <p className="text-[#8f9db1] leading-relaxed mb-4">
              ...
              <p className="text-[#8f9db1] leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-[#8f9db1] space-y-2 mb-6">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-[#8f9db1] space-y-2">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-[#8f9db1] space-y-2 mb-4">
            ...
            <section>
              ...
              <div className="text-[#8f9db1] space-y-2">
                <p>
      ...
      {/* FOOTER */}
      <footer className="border-t border-[#2a303c] py-8 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <span className="text-lg font-bold text-[#6ea8ff]">Paidly</span>
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              ...
              className="text-[#8f9db1] hover:text-[#6ea8ff] transition-colors"
            >
              <svg
                width="20"
                height="20"
