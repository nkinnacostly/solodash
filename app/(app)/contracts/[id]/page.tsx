      ...
      <div className="max-w-7xl mx-auto">
        <div className="animate-pulse space-y-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 h-[800px] bg-[#1c202a] rounded-xl" />
            <div className="h-[800px] bg-[#1c202a] rounded-xl" />
          </div>
        </div>
      </div>
    );
  ...
  if (!contract) {
    return (
      <div className="max-w-7xl mx-auto text-center py-20">
        <p className="text-[#8f9db1]">Contract not found</p>
        <Link
          href="/contracts"
          className="text-[#6ea8ff] hover:underline mt-4 inline-block"
        >
          ← Back to Contracts
        </Link>
      </div>
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          >
            {/* Document header bar */}
            <div style={{ background: "#6ea8ff" }} className="h-2 w-full" />
            ...
            <div className="p-10 relative" style={{ zIndex: 1 }}>
                  ...
                  {userProfile.logo_url ? (
                    ...
                    <p
                      style={{
                        fontSize: "64px",
                        fontWeight: "bold",
                        color: userProfile.brand_color || "#6ea8ff",
                        whiteSpace: "nowrap",
                        margin: 0,
                      }}
                    >
              ...
              <div className="flex justify-end mb-6">
                <span className="text-xs text-gray-400 flex items-center gap-1">
                  Generated by
                  <span className="text-[#3b7ae0] font-semibold">Paidly</span>
                </span>
              </div>
        ...
        <div className="space-y-6">
          {/* Status Card */}
          <div className="bg-[#1c202a] border border-[#2a303c] rounded-xl p-6 sticky top-6">
            ...
            <div className="space-y-4 mb-6">
              <div>
                <p className="text-xs text-[#8f9db1] mb-1">Status</p>
                <span
              ...
              <div>
                <p className="text-xs text-[#8f9db1] mb-1">Type</p>
                <span
              ...
              <div>
                <p className="text-xs text-[#8f9db1] mb-1">Client</p>
              ...
              <div>
                <p className="text-xs text-[#8f9db1] mb-1">Start Date</p>
                <p className="text-sm text-white">
              ...
              {contract.end_date && (
                <div>
                  <p className="text-xs text-[#8f9db1] mb-1">End Date</p>
                  <p className="text-sm text-white">
              ...
              {(contract.status === "signed" ||
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full py-3 border border-[#2a303c] text-white font-medium rounded-lg cursor-pointer hover:border-[#6ea8ff] hover:text-[#6ea8ff] transition-colors flex items-center justify-center gap-2"
                  >
                    <Download size={18} />
                    Download PDF
                  </button>
                  {contract.freelancer_signed_at && (
                    <div className="bg-[#0c2e26] border border-[#57c9b0]/30 rounded-lg p-3 text-center">
                      <CheckCircle
                        size={16}
                        className="text-[#6ea8ff] mx-auto mb-1"
                      />
                      <p className="text-xs text-[#6ea8ff]">
                        You signed on{" "}
                        {formatDate(contract.freelancer_signed_at)}
                      </p>
                    </div>
                ...
                <div key={index} className="flex items-start gap-3">
                  <div
                    className={`w-3 h-3 rounded-full mt-1 ${
                      item.active ? "bg-[#6ea8ff]" : "bg-[#2a303c]"
                    }`}
                  />
                  <div className="flex-1">
                    <p
                      className={`text-sm ${
                        item.active ? "text-white" : "text-[#8f9db1]"
                      }`}
                    >
                      {item.label}
                    </p>
