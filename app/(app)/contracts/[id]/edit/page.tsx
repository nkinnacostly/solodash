    ...
    return (
      <div className="max-w-4xl mx-auto">
        <div className="text-center py-20">
          ...
          <Link
            href="/contracts"
            className="inline-flex items-center gap-2 mt-6 px-5 py-3 bg-[#10b981] text-white font-medium rounded-lg hover:bg-[#059669] transition-colors"
          >
            <ArrowLeft size={18} />
            Back to Contracts
          </Link>
          ...
          <div>
            ...
            {initialContent !== null && (
              <div
                ...
                className="contract-content max-h-[600px] overflow-y-auto rounded-lg bg-white p-8 focus:outline-none focus:ring-2 focus:ring-[#10b981]"
                style={{
