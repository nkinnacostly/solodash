  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <WidgetWrapper<ProfileData>
          ...
          loadingFallback={
            <div className="animate-pulse space-y-2">
              <div className="h-9 bg-[#18181b] rounded w-64" />
              <div className="h-4 bg-[#18181b] rounded w-48" />
            </div>
          }
        >
          {(data) => {
        ...
        <Link
          href="/invoices/new"
          className="inline-flex items-center gap-2 px-5 py-3 bg-[#10b981] text-white font-medium rounded-lg hover:bg-[#059669] transition-colors shrink-0"
        >
          <Plus size={18} />
          New Invoice
        </Link>
        ...
        loadingFallback={
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="animate-pulse bg-[#18181b] border border-[#27272a] rounded-xl h-24"
              />
            ))}
          </div>
        }
      ...
      <WidgetWrapper<MonthlyData & { currency: string }>
        ...
        className="mb-8"
        loadingFallback={
          <div className="animate-pulse bg-[#18181b] border border-[#27272a] rounded-xl h-[340px]" />
        }
      >
        {(data) => {
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-8">
        <WidgetWrapper<RecentInvoicesData>
          ...
          loadingFallback={
            <div className="animate-pulse bg-[#18181b] border border-[#27272a] rounded-xl h-64" />
          }
        >
          {(data) => (
      ...
      <WidgetWrapper<TopClientsData & { currency: string }>
        ...
        loadingFallback={
          <div className="animate-pulse bg-[#18181b] border border-[#27272a] rounded-xl h-48" />
        }
      >
        {(data) => {
          const symbol = getCurrencySymbol(data.currency);
