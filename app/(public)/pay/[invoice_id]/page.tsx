...
function PayInvoiceContent() {
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0b] flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="animate-pulse bg-[#141419] border border-[#26262e] rounded-xl p-8">
            <div className="h-8 bg-[#26262e] rounded w-32 mb-4" />
            <div className="h-4 bg-[#26262e] rounded w-48 mb-8" />
            <div className="space-y-3 mb-6">
              <div className="h-4 bg-[#26262e] rounded w-full" />
              <div className="h-4 bg-[#26262e] rounded w-3/4" />
              <div className="h-4 bg-[#26262e] rounded w-5/6" />
            </div>
            <div className="h-12 bg-[#26262e] rounded" />
          </div>
        </div>
      </div>
    );
  ...
  if (paymentSuccess) {
    return (
      <div className="min-h-screen bg-[#0a0a0b] flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-[#141419] border border-[#3b82f6]/30 rounded-xl p-8 text-center">
            <CheckCircle
              size={64}
              className="text-[#3b82f6] mx-auto mb-4 animate-bounce"
            />
            <h1 className="text-2xl font-bold text-white mb-2">
              Payment Successful!
            </h1>
      ...
      <div className="min-h-screen bg-[#0a0a0b] flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="bg-[#141419] border border-[#26262e] rounded-xl p-8">
            ...
            {/* Divider */}
            <div className="border-t border-[#26262e] mb-6" />
            ...
            {/* Divider */}
            <div className="border-t border-[#26262e] mb-4" />
            ...
            <div className="space-y-2 mb-6">
              ...
              <div className="flex justify-between text-lg font-bold pt-2 border-t border-[#26262e]">
            ...
            {/* Due Date */}
            <div className="bg-[#0a0a0b] border border-[#26262e] rounded-lg p-3 mb-6">
            ...
            {invoice.status === "paid" && (
              <div className="bg-[#0c2e26] border border-[#57c9b0]/30 rounded-lg p-4 text-center mb-6">
                <CheckCircle
                  size={20}
                  className="text-[#3b82f6] mx-auto mb-2"
                />
